...
|-----------|-------:|----------|---------|
| **Video Generation: Controllable and Long-Form** | 255 | 📉 cooling | Text-to-video, image-to-video, and controllable video generation with emphasis on camera control, motion control, long… |
| **Robot Manipulation: Policies and Data** | 219 | 📉 cooling | Development of manipulation policies, data collection, sim-to-real transfer, and benchmarks for robotic manipulation… |
| **Vision-Language-Action Models: Training and Architecture** | 214 | 📉 cooling | Development, training, and architectural innovations for Vision-Language-Action (VLA) models that map visual and… |
| **Miscellaneous** | 174 | 📉 cooling | Papers that do not clearly fit into other directions, including surveys, position papers, and cross-domain topics. |
| **World Action Models for Robotics** | 101 | ➡️ steady | Action-conditioned world models (WAMs) that generate future video or latent representations for robot control, often… |
| **World Models: Latent Dynamics and Planning** | 88 | ➡️ steady | Predictive world models that learn latent dynamics for planning and control, including JEPA-based, Dreamer-style, and… |
| **Evaluation Benchmarks for World Models and VLAs** | 87 | 📉 cooling | New benchmarks, evaluation protocols, and diagnostic tools for assessing world models, video generation, and… |
| **Autonomous Driving and Navigation** | 82 | 📉 cooling | World models and VLAs for autonomous driving, UAV navigation, and visual navigation tasks. |
| **Efficiency, Quantization, and Acceleration** | 79 | 📉 cooling | Methods to improve efficiency of world models and VLAs through quantization, pruning, distillation, caching, and… |
| **Imitation Learning and Human-Robot Interaction** | 79 | 📉 cooling | Learning from human demonstrations, cross-embodiment transfer, teleoperation, and human-in-the-loop systems. |
| **Theoretical Foundations of World Models** | 74 | ➡️ steady | Theoretical analysis of world models including identifiability, generalization, causality, and philosophical… |
| **Safety, Security, and Robustness of World Models and VLAs** | 50 | 📉 cooling | Security threats, adversarial attacks, data poisoning, backdoors, and robustness to distribution shifts in world models… |
...
| **7.44** | FlowPilot: Real-Time World-Action Modeling for Agile UAV Navigation | 2026-08-01 | spd 8 · gen 2 · spec 8 · cost 6 | [abs](https://arxiv.org/abs/2608.00635) · [pdf](https://arxiv.org/pdf/2608.00635v1) |
...
- **[Xiaowei Chi](https://www.semanticscholar.org/author/2192825554)** (8 papers) — Xiaowei Chi's research focuses on developing world-action models (WAMs) for embodied AI, particularly for robotic manipulation. This includes integrating vision, tactile, and 4D geometry data, improving efficiency, and applying reinforcement learning to…
- **[Kaipeng Zhang](https://www.semanticscholar.org/author/2313680460)** (7 papers) — Kaipeng Zhang's research focuses on developing world models for interactive video generation, including long-horizon video synthesis, causality understanding, physics-editable dynamics, and action control. He works on frameworks like Surprise Forcing…
- **[Enze Xie](https://www.semanticscholar.org/author/41020000)** (7 papers) — Enze Xie's research focuses on accelerating video generation and world model inference through training-free techniques, attention sparsification, and hybrid attention mechanisms, while also exploring the use of egocentric human video for embodied pretraining.
- **[Jingjing Gong](https://www.semanticscholar.org/author/2371292918)** (7 papers) — Jingjing Gong's research focuses on improving Vision-Language-Action (VLA) models for robotic control, specifically addressing sample efficiency, long-horizon tasks, robustness to missing sensors, and efficient action generation through methods such as…
- **[Yao Mu](https://www.semanticscholar.org/author/2348161293)** (7 papers) — Developing Vision-Language-Action models for robotic manipulation, focusing on safety, generalization, reinforcement learning, and world action models. Also exploring bimanual dexterity and leveraging image editing for action prediction.
- **[Hangjun Ye](https://www.semanticscholar.org/author/2367554550)** (7 papers) — Research on World Action Models (WAMs) for embodied AI, including unified embodied synthesis, autonomous driving, navigation, and dynamic scene reconstruction, with focus on joint prediction of visual observations and actions, causal world models, and…
- **[Xintao Wang](https://www.semanticscholar.org/author/2305033532)** (6 papers) — Video world models and generation, focusing on long-horizon consistency, 3D geometry-aware memory, hand control, and temporal coherence.
- **[Xiaozhu Ju](https://www.semanticscholar.org/author/2392718853)** (6 papers) — Xiaozhu Ju's research focuses on developing world models and safe reinforcement learning for embodied agents, particularly vision-language-action (VLA) policies, with contributions including model-based safe RL frameworks, persistent state cores…
- **[Yann LeCun](https://www.semanticscholar.org/author/2270469816)** (6 papers) — Yann LeCun's research focuses on developing latent world models (JEPA-style) for robotics and embodied control, including long-horizon prediction, zero-shot sim-to-real transfer, and adaptive planning under distribution shift, as well as efficient policy…
- **[Hangjun Ye](https://www.semanticscholar.org/author/2384401186)** (6 papers) — Hangjun Ye's research focuses on developing unified world-action and vision-language-action models for embodied AI, including autonomous driving, navigation, and mobile manipulation. Key contributions include Discrete-WAM for compositional reasoning in…
- **[Peiyan Li](https://www.semanticscholar.org/author/2305635155)** (6 papers) — Peiyan Li's research focuses on improving robotic manipulation through embodied chain-of-thought reasoning, test-time scaling, vision-language-action model fine-tuning, and world action models. Key contributions include ERVLA, E-TTS, StaKe, FlowWAM, SKIP, and…
- **[A. T. Le](https://www.semanticscholar.org/author/2282564821)** (6 papers) — A. T. Le's research focuses on improving Vision-Language-Action (VLA) models for robot manipulation, including structured evaluation, training-free compression for efficient fine-tuning and inference, rotationally equivariant architectures, portable inference…
- **[D. M. H. Nguyen](https://www.semanticscholar.org/author/2374196339)** (6 papers) — Developing efficient, data-efficient, and robust Vision-Language-Action (VLA) models for robot manipulation, including layer compression, equivariant architectures, inference runtimes, few-shot adaptation, and self-improving policies.
- **[Xiaofeng Wang](https://www.semanticscholar.org/author/2242976725)** (6 papers) — Research focuses on embodied world models and visual navigation, integrating action and visual foresight through latent world-action modeling and diffusion transformers for robust, efficient robotic manipulation and aerial embodied question answering.
- **[Shanghang Zhang](https://www.semanticscholar.org/author/2346116279)** (6 papers) — Shanghang Zhang's research focuses on developing world-action models and safe reinforcement learning frameworks for vision-language-action (VLA) policies, with an emphasis on interactive world models, manifold-aware cross-modal alignment, and value-augmented…
- **[Chaojun Ni](https://www.semanticscholar.org/author/2326295492)** (5 papers) — Chaojun Ni's research focuses on world-action models for robotic manipulation, including hybrid-attention latent-guided online reinforcement learning, action-centered world models with visual supervision, long-horizon memory compression, and interactive video…
- **[Andrea V. Bajcsy](https://www.semanticscholar.org/author/47370841)** (5 papers) — Develops world models and inference-time steering methods for robotic manipulation, focusing on robust policy evaluation and improvement via diffusion-based video generation, adaptive test-time compute allocation, and multimodal (vision, touch, language)…
- **[Xuelong Li](https://www.semanticscholar.org/author/2336880377)** (5 papers) — Research on World Action Models and embodied intelligence, along with generative video models for photorealistic object insertion, interactive avatar generation, and physics-grounded multi-object scene generation.
- **[Song Han](https://www.semanticscholar.org/author/2283171540)** (5 papers) — Song Han's research focuses on efficient video generation and inference acceleration, including attention sparsification, hybrid linear attention, and full-stack acceleration frameworks for video diffusion models, as well as omnimodal world models for…
- **[Zheng Zhu](https://www.semanticscholar.org/author/2265968976)** (5 papers) — Zheng Zhu's research focuses on efficient world models and video generation for embodied AI, including diffusion-based video acceleration, unified visual navigation via latent world-action modeling, and disentangled video prediction for robotic manipulation.
- **[Yong Li](https://www.semanticscholar.org/author/2300459663)** (5 papers) — Developing world models for action prediction and control across diverse domains including UAV navigation, biomedical simulation, and embodied tasks, with emphasis on multi-modal reasoning and heterogeneous action unification.
- **[Qi Zhang](https://www.semanticscholar.org/author/2367267878)** (5 papers) — Research on latent world models for planning, including decomposition of world effects and action-driven components, subgoal-conditioned action generation, variable-length latent representations, generalization theory for JEPA-based world models, and…
- **[Yuan Xu](https://www.semanticscholar.org/author/2313357459)** (5 papers) — Yuan Xu's research focuses on world action models (WAM) for robotic manipulation, including test-time scaling, vision-language-action fine-tuning, and efficient world model rollouts.
- **[Yixiang Chen](https://www.semanticscholar.org/author/2366155958)** (5 papers) — Research on World Action Models (WAM) for robotic manipulation, including improving fine-tuning with stage and keyframe supervision, representing actions as optical flow, augmenting with historical event memory, accelerating world model rollout with sparse…
