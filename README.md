...
**Last updated:** 2026-08-01 · **Tracked:** 679 core · 606 adjacent ·
318 news · **16374** benchmark rows across **6567** model
variants · **30** authors
...
|-----------|-------:|----------|---------|
| **Vision-Language-Action Models for Robotics** | 403 | 📉 cooling | Unified models that integrate vision, language, and action for general-purpose robot control, including novel… |
| **Video Generation and Interactive World Simulation** | 238 | 📉 cooling | Generative models for video creation, including text-to-video, image-to-video, streaming video, and interactive video… |
| **Miscellaneous** | 188 | 📉 cooling | Papers on diverse topics including security, blockchain, music recommendation, business applications, and other areas… |
| **Planning, Control, and Reinforcement Learning** | 153 | 📉 cooling | Using world models for planning, model predictive control, reinforcement learning, and decision-making in embodied… |
| **Embodied World Models for Robotic Manipulation** | 138 | 📉 cooling | Action-conditioned world models that predict future states or videos to enable robot manipulation planning, control… |
| **Efficient Inference and Deployment** | 95 | 📉 cooling | Techniques for accelerating inference, reducing memory, quantization, caching, and deploying world models and VLA… |
| **Human-Robot Interaction and Learning from Demonstrations** | 86 | 📉 cooling | Learning from human data, teleoperation, imitation learning, human-in-the-loop systems, and cross-embodiment transfer. |
| **Evaluation Benchmarks and Diagnostics** | 71 | 📉 cooling | Benchmarks, evaluation frameworks, and diagnostic tools for assessing world models, video generation, and embodied AI… |
| **Autonomous Driving World Models and VLAs** | 62 | ➡️ steady | World models and vision-language-action models specialized for autonomous driving, including trajectory planning, scene… |
| **Multi-Agent and Multi-Modal World Models** | 50 | 📉 cooling | World models and systems for multi-agent scenarios, multi-view inputs, and integration of diverse modalities (e.g… |
| **Safety, Robustness, and Trust** | 43 | 📉 cooling | Adversarial attacks, safety alignment, robustness to distribution shift, failure detection, and verification for world… |
| **Theoretical Foundations of World Models** | 31 | 📉 cooling | Theoretical analyses covering identifiability, generalization, representation learning, and mathematical foundations of… |
...
| CTRL-World | — | FID | 72.9 | 3rd-party |
| Cloak-VLA-Overlap _(DROID)_ | Task Average | task progression rate | 72.1 | 3rd-party |
| Kinema4D | — | FID | 67.06 | 3rd-party |
| Cloak-VLA-NoAug _(DROID)_ | Task Average | task progression rate | 65.1 | 3rd-party |
...
- **[Yao Mu](https://www.semanticscholar.org/author/2348161293)** (7 papers) — Research focuses on advancing World Action Models through efficient image editing paradigms, reinforcement learning for discrete diffusion Vision-Language-Action models, and safety evaluation, as well as humanoid manipulation and open-source bimanual…
- **[Hangjun Ye](https://www.semanticscholar.org/author/2367554550)** (7 papers) — World Action Models for embodied navigation, autonomous driving, dynamic scene reconstruction, and robot manipulation, focusing on joint visual observation and trajectory generation, causal modeling, and representation learning.
- **[Xiaowei Chi](https://www.semanticscholar.org/author/2192825554)** (7 papers) — Xiaowei Chi's research focuses on developing efficient world-action models (WAMs) for robotic manipulation, emphasizing speed improvements through techniques like token sparsity and hierarchical denoising, as well as integrating tactile sensing and…
- **[Xiaozhu Ju](https://www.semanticscholar.org/author/2392718853)** (6 papers) — Xiaozhu Ju's research focuses on developing interactive world models and world action models for embodied AI, emphasizing kinematic fidelity, action generalization under distribution shift, and safe reinforcement learning for vision-language-action policies…
- **[Yann LeCun](https://www.semanticscholar.org/author/2270469816)** (6 papers) — Yann LeCun's research focuses on developing world models, including object-centric and latent dynamics models (e.g., JEPA), for hierarchical multi-stage robotic tasks, efficient embodied control, and long-horizon planning with sim-to-real transfer.
- **[Xuelong Li](https://www.semanticscholar.org/author/2336880377)** (6 papers) — Xuelong Li's research focuses on advancing video generation and editing with geometric consistency, physical plausibility, and interactive controllability, including photorealistic object insertion, multi-object scene simulation, and real-time avatar…
- **[Jingjing Gong](https://www.semanticscholar.org/author/2371292918)** (6 papers) — Research on vision-language-action models for robotic control, focusing on improving efficiency, robustness, and long-horizon task performance through techniques such as in-context world modeling, conditional routing of experts, coarse-to-fine action…
- **[Xiaofeng Wang](https://www.semanticscholar.org/author/2242976725)** (6 papers) — Xiaofeng Wang's research focuses on embodied AI, world-action modeling, and visual navigation for robots and UAVs, emphasizing unified latent space models for joint action generation and visual foresight, as well as data augmentation for manipulation policies.
- **[A. T. Le](https://www.semanticscholar.org/author/2282564821)** (6 papers) — Developing robust, data-efficient, and deployable Vision-Language-Action (VLA) models through techniques such as diffusion noise smoothing, future-oriented conditioning, rotational equivariance, structured evaluation, portable inference, and layer-wise…
- **[D. M. H. Nguyen](https://www.semanticscholar.org/author/2374196339)** (6 papers) — Developing robust, data-efficient, and computationally efficient Vision-Language-Action (VLA) models for robotic manipulation, focusing on noise-robust action smoothing, few-shot adaptation, equivariant representations, interpretable evaluation, portable…
- **[Shanghang Zhang](https://www.semanticscholar.org/author/2346116279)** (6 papers) — Shanghang Zhang's research focuses on integrating world models with action models for robotic manipulation, emphasizing kinematic-physical decoupling, cross-modal alignment, and safe reinforcement learning to improve generalization and policy evaluation.
- **[Chaojun Ni](https://www.semanticscholar.org/author/2326295492)** (5 papers) — Chaojun Ni's research focuses on World Action Models (WAM) for robotic manipulation, emphasizing long-horizon rollout consistency, real-time inference, and online reinforcement learning adaptation. Key contributions include the GigaWorld series for policy…
- **[Andrea V. Bajcsy](https://www.semanticscholar.org/author/47370841)** (5 papers) — Andrea V. Bajcsy's research focuses on improving robotic manipulation through inference-time policy steering and world models, leveraging vision, touch, and language to enhance robustness, efficiency, and test-time adaptation.
- **[Enze Xie](https://www.semanticscholar.org/author/41020000)** (5 papers) — Research focuses on efficient inference acceleration for video generation and world models, including NVFP4-based training and inference for long videos, agent-based acceleration frameworks, and adaptive computation methods. Also explores physics-consistent…
- **[Yong Li](https://www.semanticscholar.org/author/2300459663)** (5 papers) — Developing world models for heterogeneous action control, world action models with multi-modal reasoning, and applications in UAV navigation and biomedical research.
- **[Hangjun Ye](https://www.semanticscholar.org/author/2384401186)** (5 papers) — Hangjun Ye focuses on unified world-action modeling for vision-and-language navigation, social avatars with theory of mind, discrete vision-action token learning for autonomous driving, scaling vision-language-action models for mobile manipulation, and latent…
- **[Junke Wang](https://www.semanticscholar.org/author/2124919221)** (5 papers · Fudan University) — Junke Wang's research focuses on world action modeling (WAM) for robotic manipulation, developing visual-action tokenizers and world models that integrate vision and action for improved robot control and generalization.
- **[Nan Duan](https://www.semanticscholar.org/author/2360369479)** (5 papers) — Nan Duan's research focuses on efficient generative modeling for images and video, including perceptual flow matching for few-step generation, real-time streaming video generation, and memory mechanisms for infinite video. Additionally, the work on DataLadder…
- **[Zheng Zhu](https://www.semanticscholar.org/author/2109516240)** (5 papers) — Zheng Zhu's research focuses on building world-action models (WAMs) for robot policy evaluation and embodied AI, emphasizing long-horizon rollout consistency, action-centered decoding, and efficient online reinforcement learning for real-world manipulation.
- **[Fan Feng](https://www.semanticscholar.org/author/2293287494)** (5 papers) — Fan Feng's research focuses on developing efficient and task-sufficient world models and vision-language-action (VLA) models for embodied agents, emphasizing asynchronous semantic-action decoupling, causal debiasing, and adaptive inference to improve sample…
- **[Aleksandr I. Panov](https://www.semanticscholar.org/author/2238010956)** (5 papers) — Research on improving Vision-Language-Action (VLA) models for manipulation tasks, including language-conditioned optimization, safe hierarchical reinforcement learning, knowledge retention in fine-tuned VLAs, efficient offline-online training, and recurrent…
- **[Peiyan Li](https://www.semanticscholar.org/author/2305635155)** (5 papers) — Research focuses on enhancing robotic manipulation through embodied chain-of-thought, world action models, and scaling vision-language-action models, with contributions including the FlowWAM framework for unified action representation and the E-TTS framework…
- **[Xinyuan Song](https://www.semanticscholar.org/author/2384121658)** (5 papers) — Investigating world-model failures and improvements in long-horizon language agents, focusing on collapse, hallucination propagation, correction, calibration, and error analysis.
- **[Z. Cai](https://www.semanticscholar.org/author/48569716)** (5 papers) — Research on world models for long-horizon language agents, focusing on phenomena such as model collapse, grounding to reduce hallucination, stable correction, budgeted probing, and error analysis.
